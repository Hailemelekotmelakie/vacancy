...
<body>
    ...
    <div class="myAccountContainer">
        ...
        <div class="myAccountsDown">
            ...
            <a href="{{url('/my-account/approved')}}" class="myAccountDownLists">
                <i class="fa-solid fa-check-double"></i><span class="makeIconsOnly">Approved</span></a>
            <a href="{{url('/my-account/under-review')}}" class="myAccountDownLists myAccountDownListsActive"><i
    ...
    <div class="underReviewJobs">
        ...
        <div class="viewAuthPostProgressContainer">
            <div class="lotieFilesContainer">
                ...
                <lottie-player class="lotieFiles" src="https://assets7.lottiefiles.com/packages/lf20_a6ccpqri.json"
                    background="transparent" speed="1" style="width: 300px; height: 300px;" loop autoplay>
                </lottie-player>
            </div>
            <div class="carContainerOuter">
                @foreach( $underReview as $eachList )
